...
const PosControlPanel = () => {
    let intervalOptions = _.map(getSamplingIntervals(), group =>
        <optgroup label={group.groupName}>{_.map(group.options, option =>
                        ...
                        <td>
                            ...
                            <div className="js-cond-running">
                                ...
                                <div className="form-group eb-device__start-logging-container">
                                    <label for="samplingIntervalSelect" className="form-label">Sampling interval</label>
                                    <div>
                                        <select id="samplingIntervalSelect" className="form-control js-status-sampling-interval-input">
                                            {intervalOptions}
                                        </select>
                                    </div>
                                    <label for="deviceTimeCorrectionSelect" className="form-label">Device time correction</label>
                                    <div>
...
export default PosControlPanel;
