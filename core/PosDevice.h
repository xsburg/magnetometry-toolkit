...
namespace core
{
    class PosDeviceException : public common::Exception
    {
    public:
        PosDeviceException(const QString& message);
    };

    class PosDevice
    {
    public:
        SMART_PTR_T(PosDevice);
        ...
        explicit PosDevice(BufferedLogger::SharedPtr_t logger = BufferedLogger::SharedPtr_t());
